...
const OnBoardingPage = () => {
  ...
  if (page === 0) {
    return <OnboadingIntroPage onNext={handleNext} />;
  }
  return (
    <section className="min-h-screen bg-background-900 text-white  relative flex justify-center items-center py-4 px-6">
      <OnboardingCard
