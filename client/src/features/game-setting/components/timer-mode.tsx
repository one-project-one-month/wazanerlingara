...
const TimerModeSetting = () => {
    ...
    const formatTimerValue = () => {
        ...
        if (isTurn) {
            ...
            timer = String(Math.floor(timerValue / 60)).padStart(2, "0") + ":" + String(timerValue % 60).padStart(2, "0");
        }
    ...
    return (
        ...
        `}
                >
                    <IconGroupPeople className="w-8 h-8" />
            ...
            <div className="space-y-6">
                ...
                <div className="flex  justify-center gap-2 w-full">
                    ...
                    <div className="grid gird-cols-2 flex-1 mt-2">
                        ...
                        <span className="justify-self-end">{isTurn ? `${max}s` : `${Math.floor(max / 60)}mins `}</span>
                    </div>
                    <button
                        type="button"
